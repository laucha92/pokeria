...
from config.setting import handle_config
...
def main():
    ...
    global config  # Hacer config global para que sea accesible en las funciones
    ...
    try:
        # 1. Cargar la configuración del juego
        config_file = os.path.abspath("config/settings.json")  # Obtener la ruta absoluta
