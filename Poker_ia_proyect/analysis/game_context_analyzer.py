...
class InvalidRoundStateError(Exception):
    """
    Excepción que se lanza cuando el estado de la ronda (round_state) es inválido.

    Esto puede ocurrir si faltan claves requeridas, si los tipos de datos son incorrectos,
    o si los valores están fuera de los rangos permitidos.
    """
    pass
...
class GameContextAnalyzer:
    ...
    def analyze_context(self, game_state: List[float], round_state: Dict) -> Tuple[Dict[Strategy, float], Optional[Dict[str, float]]]:
        ...
        Raises:
            InvalidRoundStateError: Si el estado de la ronda es inválido.
        """
        try:
    ...
    def _validate_round_state(self, round_state: Dict):
        ...
        Args:
            round_state (Dict): El estado de la ronda a validar.
